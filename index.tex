...
__sanitizer_cov_trace_pc_guard(&guard_variable)
    ...
    \begin{itemize}
        ...
        \item \lstinline[breaklines]{-Cllvm-args=-sanitizer-coverage-trace-pc-guard} sets the correct mode
        \item \lstinline{-Cllvm-args=-sanitizer-coverage-level=3} has to be set manually here, where it is set to \code{3} automatically if clang is invoked manually
